        ...
        return (
            <div>
                <Navbar fixed="top" className="navbar-custom" expand="lg">
                    <Navbar.Brand href="/compare-prices-among-countries">Compare Prices Among Countries</Navbar.Brand>
                    <Navbar.Toggle aria-controls="responsive-navbar-nav" />
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="mr-auto">
                            <Nav.Link href="/compare-prices-among-countries/home">Home</Nav.Link>
